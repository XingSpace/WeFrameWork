...
import com.wfw.para.weframework.b.Dialog.SlideDialog;
...
public class ActivitySD extends ActivityBase implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_activity_sd);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button1:
                final SlideDialog slideDialog = new SlideDialog(getContext());

                slideDialog.setContentView(SlideDialog.PROGRESS);

                slideDialog.setTitles("进度条对话框");

                slideDialog.setRightButton("CANCEL", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        slideDialog.dismiss();
                    }
